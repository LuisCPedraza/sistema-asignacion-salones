...
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1>✏️ Editar Disponibilidad para {{ $teacher->first_name }} {{ $teacher->last_name }}</h1>
    ...
    <div class="card">
        <div class="card-body">
            <form method="POST" action="{{ route('gestion-academica.teachers.availabilities.update', [$teacher, $availability]) }}">
                @csrf @method('PUT')
                ...
                <div class="mb-3">
                    ...
                    <textarea name="notes" class="form-control @error('notes') is-invalid @enderror" 
                        rows="3" placeholder="Ej: Preferencia para clases teóricas, necesita proyector, etc.">{{ old('notes', $availability->notes) }}</textarea>
