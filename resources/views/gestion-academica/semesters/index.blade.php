                        ...
                        @if($semesters->hasPages())
                            <nav aria-label="Paginación" class="mt-4">
                                <ul class="pagination justify-content-center">
                                    ...
                                    @else
                                        <li class="page-item"><a class="page-link" href="{{ $semesters->previousPageUrl() }}">← Anterior</a></li>
                                    @endif
                                    ...
                                    @if ($semesters->hasMorePages())
                                        <li class="page-item"><a class="page-link" href="{{ $semesters->nextPageUrl() }}">Siguiente →</a></li>
                                    @else
