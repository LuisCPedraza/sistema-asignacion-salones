...
<div class="container mx-auto px-4 py-8">
    ...
    <form method="POST" action="{{ route('admin.salones.update', $salon) }}">
        ...
        <div class="mb-4">
            ...
            <input type="number" name="capacidad" id="capacidad" value="{{ $salon->capacidad }}" min="1" class="border rounded px-2 py-1 w-full @error('capacidad') border-red-500 @enderror" required>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="ubicacion" id="ubicacion" value="{{ $salon->ubicacion }}" class="border rounded px-2 py-1 w-full @error('ubicacion') border-red-500 @enderror">
