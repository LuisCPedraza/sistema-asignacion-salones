...
<div class="container mx-auto px-4 py-8">
    <h1 class="text-2xl font-bold mb-6">Crear Asignación</h1>
    <form method="POST" action="{{ route('admin.asignaciones.store') }}">
        ...
        <div class="mb-4">
            ...
            <select name="salon_id" id="salon_id" class="border rounded px-2 py-1 w-full @error('salon_id') border-red-500 @enderror" required>
                <option value="" disabled {{ old('salon_id') ? '' : 'selected' }}>Selecciona un salón</option>
        ...
        <button type="submit" class="bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600">Crear Asignación</button>
