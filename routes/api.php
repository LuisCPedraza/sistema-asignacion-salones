...
Route::prefix('webhooks/n8n')->middleware('validate.n8n.token')->group(function () {
        ...
        return response()->json([
            ...
            'assignments' => $assignments->map(function ($assignment) {
                return [
                    ...
                    // Evitamos relación no definida: devolvemos el ID del grupo
    ...
    // Endpoint: Búsqueda flexible de materias por texto (coincidencia aproximada)
    Route::get('/subjects/search', function (Request $request) {
        ...
        // Sugerencia: materia más similar por distancia de Levenshtein (si está disponible)
        // En SQLite no tenemos función nativa, así que devolvemos el top por LIKE.
    ...
    // Endpoint: Carreras con detalles completos (evitar columnas ambiguas)
